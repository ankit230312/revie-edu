                                    ...
                                    <form class="form" method="POST" action="" >
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="Organisation code" name="org_code">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Organisation Name</label>
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Organisation Name" name="org_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="companyName" class="form-control" placeholder="Address" name="org_add">
                                            </div>
