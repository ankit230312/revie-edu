...
if (isset($_POST['class_title']) || isset($_POST['org_id'])) {
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form id="classForm" class="form" method="POST">
                                        <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary" id="class_save" name="class_save">
...
<script>
    $(document).ready(function() {
        $('#classForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'create_class.php', // Replace with the correct path to your PHP script
                data: formData,
                success: function(response) {
                    ...
                    // Optionally, clear or reset the form fields here
                },
