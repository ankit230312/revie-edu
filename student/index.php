                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-truncate">
                                                <div class="avatar avatar-md mr-1">
                                                    <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-11.png" alt="Generic placeholder image">
                                                </div>
                                        ...
                                        <tr>
                                            <td class="text-truncate">
                                                <div class="avatar avatar-md mr-1">
                                                    <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-14.png" alt="Generic placeholder image">
                                                </div>
                                        ...
                                        <tr>
                                            <td class="text-truncate">
                                                <div class="avatar avatar-md mr-1">
                                                    <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-15.png" alt="Generic placeholder image">
                                                </div>
                                        ...
                                        <tr>
                                            <td class="text-truncate">
                                                <div class="avatar avatar-md mr-1">
                                                    <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-4.png" alt="Generic placeholder image">
                                                </div>
                                        ...
                                        <tr>
                                            <td class="text-truncate">
                                                <div class="avatar avatar-md mr-1">
                                                    <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-19.png" alt="Generic placeholder image">
                                                </div>
                                            ...
                                            <div>
                                                <ul class="list-unstyled users-list cursor-pointer m-0 d-flex align-items-center">
                                                    <li class="avatar avatar-sm pull-up my-0">
                                                        <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-20.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Ogasawara">
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="timeline-items timeline-icon-info">
                                            ...
                                            <div>
                                                <ul class="list-unstyled users-list cursor-pointer m-0 d-flex align-items-center">
                                                    ...
                                                    <li class="avatar avatar-sm pull-up my-0">
                                                        <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-21.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Stepan">
                                                    </li>
                                                    <li class="avatar avatar-sm pull-up my-0">
                                                        <img class="rounded-circle" src="../assets/app-assets/images/portrait/small/avatar-s-22.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Kimberly">
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
