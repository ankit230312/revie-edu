                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form">
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="feather icon-user"></i> Edit Roles</h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Roles Name</label>
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="Role Name" name="fname">
                                                    </div>
                                                </div>
